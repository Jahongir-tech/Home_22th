...
const CreateUser = () => {
  ...
  return (
    <div className="h-screen flex justify-center items-center bg-gradient-to-r ">
      <form
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-blue-400 text-white py-2 rounded-md text-lg font-semibold hover:bg-blue-700 transition duration-200"
        >
          Submit
        </button>
      </form>
